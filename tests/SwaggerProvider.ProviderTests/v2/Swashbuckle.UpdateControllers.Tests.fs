...
let ``Update Guid GET Test``() =
    api.GetApiUpdateGuid(guid.ToString()) |> asyncEqual(guid.ToString())

[<Fact>]
let ``Update Guid POST Test``() =
    api.PostApiUpdateGuid(guid.ToString()) |> asyncEqual(guid.ToString())
...
let ``Update Array Guid GET Test``() =
    api.GetApiUpdateArrayGuid([| guid.ToString(); guid2.ToString(); guid3.ToString() |])
    |> asyncEqual [| guid3.ToString(); guid2.ToString(); guid.ToString() |]

[<Fact>]
let ``Update Array Guid POST Test``() =
    api.PostApiUpdateArrayGuid([| guid.ToString(); guid2.ToString(); guid3.ToString() |])
    |> asyncEqual [| guid3.ToString(); guid2.ToString(); guid.ToString() |]
